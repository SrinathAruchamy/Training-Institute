...
<nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container-fluid">
            <div class="navbar-header">
                <a href="#" class="navbar-brand " style="color: whitesmoke;"><b><h4>TRAINING INSTITUTE</h4></b> </a>
            </div>
...
<div class="container " style="margin-top: 200px;">
        ...
        <div class="col-md-5">
         <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQvVP1l5YMYisX4EhNHKJ6xZrUXq5bGo20v4wwHBEtfyg&usqp=CAU&ec=48665701" alt="Los Angeles" style="width:100%; height:350px;">
        </div>
